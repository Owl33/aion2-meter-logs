...
export default function UploadPage() {
  ...
  return (
    <div className="mx-auto flex max-w-[560px] flex-col gap-6 px-5 py-10">
      <div>
      ...
      <Card className="border-border/50 shadow-none">
        <CardContent className="flex flex-col gap-5 p-5">
          ...
          <div
            className={cn(
              "cursor-pointer rounded-xl border-[1.5px] border-dashed p-10 text-center transition-all",
            ...
            {selectedFile ? (
              <div className="flex flex-col items-center gap-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">
                  ...
                  >
                    <path
                      d="M4 4h8l4 4v8a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z"
                      stroke="currentColor"
                      strokeWidth="1.3"
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-muted">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M4 14a3 3 0 010-6h.5A5 5 0 0114.5 5H15a3 3 0 010 6"
                      stroke="currentColor"
                      strokeWidth="1.3"
                      strokeLinecap="round"
                    />
          ...
          {/* 안내 */}
          <div className="flex gap-2 rounded-lg border border-border/40 bg-muted/50 p-3">
            <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
            <p className="text-[11px] leading-relaxed text-muted-foreground">
              업로드된 로그는 공개 랭킹에 반영됩니다. 개인 정보는 포함되지
              않으며 언제든지 삭제를 요청할 수 있습니다.
            </p>
          </div>
          ...
          {uploadState === "done" ? (
            ...
            <Button
              className="h-10 bg-primary text-white hover:bg-[#6B5FD0]"
